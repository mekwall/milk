...
use Milk\Utils\Markup\Markdown;
...
class Markup {
	...
	const WIKI 			= 'wiki';
	const BBCODE 		= 'bbcode';
	const XBBCODE		= 'xbbcode';
	const CSS			= 'css';
	const MARKDOWN 		= 'markdown';
	const TEXTILE		= 'textile';
	const TXT2TAGS		= 'txt2tags';
	const RESTRUCTURED 	= 'restructured';
	const DOTCLEAR		= 'dotclear';
	const MARKMIN		= 'markmin';
...
/**
	...
	PHP Markdown
	@copyright 2004-2009, Michel Fortin  
...
class Markdown implements Parser {
	...
	**/
	...
	private $empty_element_suffix = self::EMPTY_ELEMENT_SUFFIX;
	private $tab_width = self::TAB_WIDTH;
	...
	/**
		String length function for detab. `_initDetab` will create a 
		function to handle UTF-8 if the default function does not exist.
	**/
	...
	**/
	...
	/**
		These are all the transformations that occur *within* 
	...
	**/
	...
	/**
		...
		Output: the email address as a mailto link, with each character
		  ...
		  <p><a href="&//109;&//x61;&//105;&//x6c;&//116;&//x6f;&//58;&//x66;o&//111;
	        &//x40;&//101;&//x78;&//97;&//x6d;&//112;&//x6c;&//101;&//46;&//x63;&//111;
	        &//x6d;">&//x66;o&//111;&//x40;&//101;&//x78;&//97;&//x6d;&//112;&//x6c;
	        &//101;&//46;&//x63;&//111;&//x6d;</a></p>
